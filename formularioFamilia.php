...
<body>
    ...
    <div class="body">
        ...
        <form id="form" action="save.php" method="POST">
            ...
            <div class="form">
                <br>
                <h1>REGISTRAR SALUD FAMILIA</h1>
                <h2>(Datos personales)</h2>

                <label class="campo_Id">Número identificacion</label>
                <input type="number" class="id" id="identificacion" name="identificacion" placeholder="Ingresa numero de identificación" >
              

                <label class="campo_Nombre">Nombre Completo</label>
                <input type="text" class="nombre" id="nombre" name = "nombre"placeholder="Ingresa nombre completo">
                ...
                <input type="number" class="edad" id="edad" name="edad" required placeholder="Ingresa edad">

                <label class="campo_Correo">Correo Electronico</label>
                <input type="email" class="email" id="email" name="correo" placeholder="Ingresa Correo electronico">
                ...
                <input type="text" class="otro" id="otro" placeholder="Ingresa una condicion distinta" name="otracondicionsalud">
            </div>
